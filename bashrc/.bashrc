...
if [ -x /usr/bin/dircolors ]; then
    ...
    # making all these commands run in color mode
...
export PATH=$HOME_BIN_PATH:$DOTNET_ROOT:$PATH
...
alias desktop="cd /mnt/c/Users/verma/Desktop"
